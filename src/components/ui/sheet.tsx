...
const sheetVariants = cva(
  "fixed z-50 gap-4 border-[color:var(--glass-border)] bg-background/80 p-6 shadow-[var(--shadow-card)] backdrop-blur-xl transition ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-500 data-[state=open]:animate-in data-[state=closed]:animate-out",
  {
    variants: {
      side: {
