...
function CalendarPage() {
  ...
  return (
    <div className="space-y-6">
      <SectionHeading title="Calendar" sub="Income, reminders, deadlines." />
      ...
      <div className="fintech-card p-4 sm:p-6">
        ...
        <div className="bento-grid grid grid-cols-7 gap-1 text-[10px] uppercase tracking-widest text-muted-foreground mb-1">
          {["Sun","Mon","Tue","Wed","Thu","Fri","Sat"].map((d) => <div key={d} className="text-center py-1">{d}</div>)}
        </div>
        <div className="bento-grid grid grid-cols-7 gap-1">
          {cells.map((d, idx) => (
